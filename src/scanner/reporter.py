        ...
        for i, f in enumerate(findings):
            ...
            <div class="finding" style="border-left: 4px solid {color};">
                ...
                <div class="finding-body">
                    ...
                    <div class="details">
                        <span title="File Path" aria-label="File Path"><span aria-hidden="true">📄</span> {f['filepath']}</span>
                        <span title="Line Number" aria-label="Line Number"><span aria-hidden="true">📍</span> Line {f.get('line', '?')}</span>
                        <span title="CWE Reference" aria-label="CWE Reference"><span aria-hidden="true">🏷️</span> {f['cwe_id']}</span>
                        <span title="OWASP Category" aria-label="OWASP Category"><span aria-hidden="true">📋</span> {f['owasp']}</span>
                        <span title="Analysis Source" aria-label="Analysis Source"><span aria-hidden="true">🔍</span> {f['source']}</span>
                    </div>
