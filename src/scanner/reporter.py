        ...
        for i, f in enumerate(findings):
            ...
            <div class="finding" style="border-left: 4px solid {color};">
                ...
                <div class="finding-body">
                    ...
                    <div class="details">
                        <span title="File path"><span aria-hidden="true">📄</span> <span class="sr-only">File path: </span>{f['filepath']}</span>
                        <span title="Line number"><span aria-hidden="true">📍</span> <span class="sr-only">Line: </span>Line {f.get('line', '?')}</span>
                        <span title="CWE ID"><span aria-hidden="true">🏷️</span> <span class="sr-only">CWE ID: </span>{f['cwe_id']}</span>
                        <span title="OWASP Category"><span aria-hidden="true">📋</span> <span class="sr-only">OWASP Category: </span>{f['owasp']}</span>
                        <span title="Detection Source"><span aria-hidden="true">🔍</span> <span class="sr-only">Detection Source: </span>{f['source']}</span>
                    </div>
