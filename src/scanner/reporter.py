        ...
        for i, f in enumerate(findings):
            ...
            <div class="finding" style="border-left: 4px solid {color};">
                ...
                <div class="finding-body">
                    ...
                    <div class="details">
                        <span><span aria-hidden="true">📄</span> {f['filepath']}</span>
                        <span><span aria-hidden="true">📍</span> Line {f.get('line', '?')}</span>
                        <span><span aria-hidden="true">🏷️</span> {f['cwe_id']}</span>
                        <span><span aria-hidden="true">📋</span> {f['owasp']}</span>
                        <span><span aria-hidden="true">🔍</span> {f['source']}</span>
                    </div>
...
<body>
    <main role="main" class="container">
        ...
        <div role="region" aria-labelledby="vuln-breakdown-title" style="background: var(--bg-card); border-radius: 12px; padding: 1.5rem; border: 1px solid var(--border);">
            {chart_items}
        </div>

        <h2 id="detailed-findings-title" class="section-title">Detailed Findings ({len(findings)})</h2>
        <div role="region" aria-labelledby="detailed-findings-title">
